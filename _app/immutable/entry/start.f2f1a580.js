import { o as me, t as we } from "../chunks/index.eaa2c7e1.js";
import {
  S as Ge,
  a as Je,
  I as M,
  ...
  P as Me,
  e as Ze,
} from "../chunks/singletons.accdca71.js";
import { b as q } from "../chunks/paths.8879dda4.js";
function Qe(t, r) {
  return t === "/" || r === "ignore"
    ? t
    : r === "never"
  ...
  function Xe() {
    ...
    const n = new IntersectionObserver(
      (c) => {
        for (const h of c)
          h.isIntersecting &&
            (oe(se(new URL(h.target.href))), n.unobserve(h.target));
      },
      { threshold: 0 }
    );
    function o(c, h) {
...
async function He(t, r) {
  ...
  if (
    ((p = i.headers.get("content-type")) != null &&
      p.includes("text/html") &&
      (await K(t)),
    !i.ok)
  )
